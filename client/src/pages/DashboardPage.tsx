          ...
          <div className="flex-1 p-4 space-y-6">
            ...
            <nav className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center space-x-2 px-2 py-2 text-left text-white hover:bg-white/10 rounded-lg transition-all duration-200 group"
              >
                ...
                <span className="text-sm font-medium group-hover:text-green-300 transition-colors">Gioca</span>
              ...
              <button className="w-full flex items-center space-x-3 px-4 py-3 text-left text-white hover:bg-white/10 rounded-xl transition-all duration-300 group hover:translate-x-1 hover:shadow-lg">
                ...
                <span className="text-sm font-medium group-hover:text-blue-300 transition-colors">Impara</span>
                <div className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity">
                  <svg className="w-4 h-4 text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
              ...
              <button className="w-full flex items-center space-x-3 px-4 py-3 text-left text-white hover:bg-white/10 rounded-xl transition-all duration-300 group hover:translate-x-1 hover:shadow-lg">
                ...
                <span className="text-sm font-medium group-hover:text-amber-300 transition-colors">Classifica</span>
                <div className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity">
                  <svg className="w-4 h-4 text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
              ...
              <button className="w-full flex items-center space-x-3 px-4 py-3 text-left text-white hover:bg-white/10 rounded-xl transition-all duration-300 group hover:translate-x-1 hover:shadow-lg">
                ...
                <span className="text-sm font-medium group-hover:text-purple-300 transition-colors">Leghe</span>
                <div className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity">
                  <svg className="w-4 h-4 text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>

...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="flex">
        {/* Left Sidebar */}
        <aside className="w-64 bg-gray-900/95 backdrop-blur-2xl border-r border-white/10 min-h-screen shadow-2xl">
          <div className="p-5 space-y-6">
            {/* Logo */}
            <Link
              to="/dashboard"
              className="block hover:opacity-90 transition-all duration-300 px-4"
            >
              <img
            ...
            <div className="px-2 py-4 border-b border-white/10">
              <div className="flex items-center space-x-3 px-3 py-3 bg-white/5 rounded-xl border border-white/5">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-gray-400 text-xs">
                    {user?.rating || 1000} • {user?.level?.name || 'Beginner'}
                  </div>
                </div>
              </div>
            </div>
            ...
            <nav className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center space-x-3 px-4 py-3 text-left text-white hover:bg-white/10 rounded-xl transition-all duration-300 group hover:translate-x-1 hover:shadow-lg"
              >
                ...
                <span className="font-semibold group-hover:text-green-300 transition-colors duration-300">Gioca</span>
              ...
              {/* Impara */}
              <button className="w-full flex items-center space-x-3 px-4 py-3 text-left text-white hover:bg-white/10 rounded-xl transition-all duration-300 group hover:translate-x-1 hover:shadow-lg">
                ...
                <span className="font-semibold group-hover:text-blue-300 transition-colors duration-300">Impara</span>
                <div className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <svg className="w-4 h-4 text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
              ...
              {/* Classifica */}
              <button className="w-full flex items-center space-x-3 px-4 py-3 text-left text-white hover:bg-white/10 rounded-xl transition-all duration-300 group hover:translate-x-1 hover:shadow-lg">
                <svg className="w-5 h-5 text-amber-400 group-hover:text-amber-300 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
                <span className="font-semibold group-hover:text-amber-300 transition-colors duration-300">Classifica</span>
                <div className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <svg className="w-4 h-4 text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
              ...
              <button className="w-full flex items-center space-x-3 px-4 py-3 text-left text-white hover:bg-white/10 rounded-xl transition-all duration-300 group hover:translate-x-1 hover:shadow-lg">
                ...
                <span className="font-semibold group-hover:text-purple-300 transition-colors duration-300">Leghe</span>
                <div className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <svg className="w-4 h-4 text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
            ...
            <div className="px-2 py-4 border-t border-white/10">
              <div className="space-y-2">
                <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-wide px-2">Azioni Rapide</h4>

                <button className="w-full flex items-center space-x-3 px-3 py-2 text-left text-white hover:bg-white/10 rounded-lg transition-all duration-200 text-sm">
                ...
                <button
                  ...
                  className="w-full flex items-center space-x-3 px-3 py-2 text-left text-red-400 hover:bg-red-500/10 rounded-lg transition-all duration-200 text-sm hover:text-red-300"
                >

        ...
        <aside className="w-44 bg-gray-900/95 backdrop-blur-2xl border-r border-white/10 min-h-screen shadow-2xl flex flex-col">
          ...
          <div className="px-3 py-4 border-t border-white/10">
            <div className="space-y-2">
              <button className="w-full flex items-center space-x-2 py-2 text-left text-white hover:bg-white/10 rounded-lg transition-all duration-200 text-sm">
              ...
              <button
                ...
                className="w-full flex items-center space-x-2 py-2 text-left text-red-400 hover:bg-red-500/10 rounded-lg transition-all duration-200 text-sm hover:text-red-300"
              >

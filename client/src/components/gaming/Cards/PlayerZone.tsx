              ...
              {cardState.activeCards.map((card, index) => (
                ...
                >
                  {isCurrentPlayer ? (
                    ...
                    <div className="w-14 h-[78px] bg-gradient-to-br from-indigo-600 to-purple-600 rounded-md shadow-md border border-slate-600 flex items-center justify-center">
            ...
            {cardState.activeCards.length < 5 && (
              <div className="space-y-1">
                {Array.from({ length: 5 - cardState.activeCards.length }, (_, i) => (
                  <div
                    key={`empty-${i}`}
                    className="w-14 h-[78px] border-2 border-dashed border-slate-600 rounded-md flex items-center justify-center opacity-30"
                  >
                  ...
                  {cardState.reserveCards.map((card, index) => (
                    ...
                    >
                      {isCurrentPlayer ? (
                        ...
                        <div className="w-14 h-[78px] bg-gradient-to-br from-purple-600 to-indigo-600 rounded-md shadow-md border border-slate-600 flex items-center justify-center opacity-60">
